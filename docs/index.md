...
Each crosswalk maps a schema's properties against a shared reference set of CodeMeta and Schema.org properties. The crosswalks were developed collaboratively by contributors from the NFDI Research Software Metadata Working Group. These crosswalks were the empirical foundation for ConnOSS Metadata Schema. the unmapped properties identified across schemas were curated as candidates for extending CodeMeta, and the resulting unified schema was released as ConnOSS Metadata Schema. The complete set of crosswalks is openly available on Zenodo [https://zenodo.org/records/19418049].